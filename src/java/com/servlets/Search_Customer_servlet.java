 ...
 * @author manish
 */
public class Search_Customer_servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Search_Customer_servlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            Customer data=dao.search_customer(aadhar);
            ...
            {
                HttpSession s=request.getSession();
                s.setAttribute("search_employee", data);
                response.sendRedirect("search_customer.jsp");
            }
